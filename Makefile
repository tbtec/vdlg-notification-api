...
build-docker:
	docker build -t tbtec/${BINARY_NAME}:1.0.0 .	

run-docker:
	docker run -p 8080:8080 tbtec/${BINARY_NAME}:1.0.0 --env-file .env
...
docker-push:
	docker push tbtec/${BINARY_NAME}:1.0.0
